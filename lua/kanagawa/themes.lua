...
return {
	...
	dragon = function(palette)
		return {
			ui = {
				fg = palette.restoredWhite,
				fg_dim = palette.oldWhite,
				fg_reverse = palette.waveBlue1,

				bg_dim = palette.restoredBlack1,
				bg_gutter = palette.restoredBlack4,

				bg_m3 = palette.restoredBlack0,
				bg_m2 = palette.restoredBlack1,
				bg_m1 = palette.restoredBlack2,
				bg = palette.restoredBlack3,
				bg_p1 = palette.restoredBlack4,
				bg_p2 = palette.restoredBlack5,

				special = palette.restoredGray3,
				whitespace = palette.restoredBlack6,
				nontext = palette.restoredBlack6,
				...
				float = {
					fg = palette.oldWhite,
					bg = palette.restoredBlack0,
					fg_border = palette.sumiInk6,
					bg_border = palette.restoredBlack0,
				},
			},
			syn = {
				string = palette.restoredGreen2,
				variable = "none",
				number = palette.restoredPink,
				constant = palette.restoredOrange,
				identifier = palette.restoredYellow,
				parameter = palette.restoredGray,
				fun = palette.restoredBlue2,
				statement = palette.restoredViolet,
				keyword = palette.restoredViolet,
				operator = palette.restoredRed,
				preproc = palette.restoredRed,
				type = palette.restoredAqua,
				regex = palette.restoredRed,
				deprecated = palette.katanaGray,
				punct = palette.restoredGray2,
				comment = palette.restoredAsh,
				special1 = palette.restoredTeal,
				special2 = palette.restoredRed,
				special3 = palette.restoredRed,
			},
			diag = {
				error = palette.samuraiRed,
				ok = palette.springGreen,
			...
			term = {
				palette.restoredBlack0, -- black
				palette.restoredRed, -- red
				palette.restoredGreen2, -- green
				palette.restoredYellow, -- yellow
				palette.restoredBlue2, -- blue
				palette.restoredPink, -- magenta
				palette.restoredAqua, -- cyan
				palette.oldWhite, -- white
				palette.restoredGray, -- bright black
				palette.waveRed, -- bright red
				palette.restoredGreen, -- bright green
				palette.carpYellow, -- bright yellow
				palette.springBlue, -- bright blue
				palette.springViolet1, -- bright magenta
				palette.waveAqua2, -- bright cyan
				palette.restoredWhite, -- bright white
				palette.restoredOrange, -- extended color 1
				palette.restoredOrange2, -- extended color 2
			},
		}
	end,
	---@param palette PaletteColors
