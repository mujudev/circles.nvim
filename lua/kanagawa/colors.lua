...
local palette = {
	...
	restoredBlack0 = "#0d0c0c",
	restoredBlack1 = "#12120f",
	restoredBlack2 = "#1D1C19",
	restoredBlack3 = "#181616",
	restoredBlack4 = "#282727",
	restoredBlack5 = "#393836",
	restoredBlack6 = "#625e5a",

	restoredWhite = "#c5c9c5",
	restoredGreen = "#87a987",
	restoredGreen2 = "#8a9a7b",
	restoredPink = "#a292a3",
	restoredOrange = "#b6927b",
	restoredOrange2 = "#b98d7b",
	restoredGray = "#a6a69c",
	restoredGray2 = "#9e9b93",
	restoredGray3 = "#7a8382",
	restoredBlue2 = "#8ba4b0",
	restoredViolet = "#8992a7",
	restoredRed = "#c4746e",
	restoredAqua = "#8ea4a2",
	restoredAsh = "#737c73",
	restoredTeal = "#949fb5",
	restoredYellow = "#c4b28a", --"#a99c8b",
	-- "#8a9aa3",
